...
namespace Nana.Framework.Utility
{
    public class ValidateHelper
    {
        ...
        {
            return Regex.IsMatch(source, @"^0?(1)[0-9]{10}$", RegexOptions.IgnoreCase);
        }
        ...
        /// <summary>
        /// 是不是中国电话，格式010-85849685或010-85849685-9876
        /// </summary>
        /// <param name="source"></param>
        /// <returns></returns>
        public static bool IsTel(string source)
        {
            return Regex.IsMatch(source, @"^\d{3,4}-?\d{6,8}(-\d{1,5})?$", RegexOptions.IgnoreCase);
        }
