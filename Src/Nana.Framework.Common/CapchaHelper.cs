...
namespace Nana.Framework.Common
{
    public class CapchaHelper
    {
        ...
        public void RenderGraphic(Stream outputStream, string randomCode)
        {
            Bitmap image = new Bitmap(GetImageWidth(randomCode.Length), GetImageHeight());
            ...
            try
            {
                ...
                g.DrawString(randomCode, font, brush, 3, 4);
